export interface MenuItem {
  ...
  price: number;
  category: 'menu_del_dia' | 'starters' | 'salads' | 'tandoor' | 'veg_curry' | 'chicken_curry' | 'fish_prawn_curry' | 'lamb_curry' | 'biryani' | 'sides' | 'wines' | 'drinks' | 'beers' | 'spirits' | 'coffees' | 'desserts';
  image?: string;
  isSpicy?: boolean;
  isVeg?: boolean;
  number?: number;
