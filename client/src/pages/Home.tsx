              ...
              <div className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground font-mono">v8.10</span>
                  </div>
                </div>
            ...
            <div className="absolute bottom-4 left-4 md:bottom-6 md:left-8 z-20 flex items-center gap-3 md:gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="text-xs md:text-sm text-muted-foreground font-mono mt-1 md:mt-2">v8.10</span>
                </div>
